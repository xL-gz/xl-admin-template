...
(15, 'admin-system', '系统配置', '系统配置', 'system-config', 10, 5, 5, '/system/config', 'system/sysConfig/index', 'system/sysConfig/index', 'C', 2, 'Web', '0', '0', 1, 'system:config:view', 'icon-ym icon-ym-config', '{"moduleId":"system-config"}', '系统配置'),
