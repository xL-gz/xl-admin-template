<template>
  <BasicModal v-bind="$attrs" @register="registerModal" title="请选择流程" width="400px" :footer="null" destroyOnClose class="youyi-flow-list-modal">
    ...
    <div class="template-list">
      <ScrollContainer>
        ...
        <youyi-empty v-if="!getFlowList.length" />
      </ScrollContainer>
    </div>
  </BasicModal>
</template>
