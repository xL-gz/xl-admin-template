<template>
  <BasicModal
    ...
    @ok="handleSubmit"
    destroyOnClose
    class="youyi-super-query-modal youyi-condition-modal">
...
<script lang="ts" setup>
  ...
  const state = reactive<State>({
    planList: [],
    conditionList: [
      { logic: 'and', groups: [{ field: '', symbol: '', youyiKey: '', fieldValueType: 2, fieldValue: undefined, fieldValueYouyiKey: '', cellKey: +new Date() }] },
    ],
