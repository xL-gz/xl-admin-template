...
export const modalProps = {
  ...
  cancelText: { type: String, default: t('common.cancelText', '取消') },
  okText: { type: String, default: t('common.okText','确定') },
  continueText: { type: String, default: t('common.continueText','继续') },
