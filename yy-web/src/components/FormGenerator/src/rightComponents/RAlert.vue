<template>
  <a-form-item label="提示文本">
    <youyi-i18n-input v-model:value="activeData.title" v-model:i18n="activeData.titleI18nCode" placeholder="请输入" />
  </a-form-item>
  <a-form-item label="辅助文本">
    <youyi-i18n-input v-model:value="activeData.description" v-model:i18n="activeData.descriptionI18nCode" placeholder="请输入" />
  </a-form-item>
  ...
  <a-form-item label="按钮文字" v-if="activeData.closable">
    <youyi-i18n-input v-model:value="activeData.closeText" v-model:i18n="activeData.closeTextI18nCode" :maxlength="10" placeholder="请输入" />
  </a-form-item>
</template>
