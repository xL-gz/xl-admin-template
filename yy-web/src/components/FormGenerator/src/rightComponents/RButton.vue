<template>
  <a-form-item label="控件文本">
    <youyi-i18n-input v-model:value="activeData.buttonText" v-model:i18n="activeData.buttonTextI18nCode" placeholder="请输入" />
  </a-form-item>
  <a-form-item label="对齐方式">
    <youyi-radio v-model:value="activeData.align" :options="alignOptions" optionType="button" button-style="solid" class="right-radio" />
  </a-form-item>
