<template>
  <a-form :colon="false" layout="vertical" class="right-board-form">
    <a-form-item label="表单尺寸">
      <youyi-radio v-model:value="formConf.size" :options="sizeOptions" optionType="button" button-style="solid" />
    </a-form-item>
    <a-form-item label="标签对齐">
      <youyi-radio v-model:value="formConf.labelPosition" :options="labelPositionOptions" optionType="button" button-style="solid" class="right-radio" />
    </a-form-item>
    ...
    <a-form-item label="弹窗类型">
      <youyi-select v-model:value="formConf.popupType" :options="popupTypeOptions" />
    </a-form-item>
    ...
    <a-form-item>
      ...
      <youyi-select v-model:value="formConf.className" multiple allowClear :options="getClassNameOptions" showSearch />
    </a-form-item>
    <a-form-item label="主键策略">
      <youyi-select v-model:value="formConf.primaryKeyPolicy" :options="policyOptions" :disabled="!!formInfo.id" />
    </a-form-item>
    <a-form-item>
    ...
    <div class="btn-config-list">
      <div class="btn-cell">
        ...
        <youyi-i18n-input v-model:value="formConf.confirmButtonText" v-model:i18n="formConf.confirmButtonTextI18nCode" placeholder="请输入" />
      </div>
      <div class="btn-cell">
        <a-checkbox v-model:checked="formConf.hasCancelBtn" disabled>取消</a-checkbox>
        <youyi-i18n-input v-model:value="formConf.cancelButtonText" v-model:i18n="formConf.cancelButtonTextI18nCode" placeholder="请输入" />
      </div>
      <div class="btn-cell" v-if="showType == 'pc'">
        ...
        <youyi-i18n-input v-model:value="formConf.printButtonText" v-model:i18n="formConf.printButtonTextI18nCode" placeholder="请输入" />
      </div>
