...
<script lang="ts" setup>
  ...
  defineOptions({ name: 'YouyiCheckbox', inheritAttrs: false });
  ...
  const getBindValue = computed(() => ({
    ...unref(attrs),
    class: unref(attrs).class ? `youyi-${props.direction}-checkbox ${unref(attrs).class}` : `youyi-${props.direction}-checkbox`,
  }));
