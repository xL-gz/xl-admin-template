...
<script lang="ts" setup>
  // import { getRoleByCondition } from '@/api/permission/role'; // 已删除 - 后端无此接口
  // 占位符函数
  const getRoleByCondition = () => Promise.resolve({ data: { list: [] } });
  ...
  defineOptions({ name: 'YouyiRoleSelect', inheritAttrs: false });
