...
<script lang="ts" setup>
  // import { getImUserSelector, getSelectedList, getSelectedUserList } from '@/api/permission/user'; // 已删除 - 后端无此接口
  // 占位符函数
  ...
  defineOptions({ name: 'YouyiUsersSelect', inheritAttrs: false });
