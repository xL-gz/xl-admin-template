<template>
  <div :class="prefixCls" v-bind="getBindValue">
    <InputNumber v-model:value="min" :placeholder="t('component.youyi.numberRange.min')" :precision="getPrecision" :controls="false" @change="onChange" />
    <span class="separator">-</span>
    <InputNumber v-model:value="max" :placeholder="t('component.youyi.numberRange.max')" :precision="getPrecision" :controls="false" @change="onChange" />
  </div>
</template>
...
<script lang="ts" setup>
  ...
  defineOptions({ name: 'YouyiNumberRange', inheritAttrs: false });
