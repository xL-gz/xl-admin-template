...
<script lang="ts" setup>
  ...
  defineOptions({ name: 'YouyiRadio', inheritAttrs: false });
  ...
  const getBindValue = computed(() => ({
    ...unref(attrs),
    class: unref(attrs).class ? `youyi-${props.direction}-radio ${unref(attrs).class}` : `youyi-${props.direction}-radio`,
  }));
