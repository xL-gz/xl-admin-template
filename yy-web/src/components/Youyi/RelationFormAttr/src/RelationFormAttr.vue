...
<script lang="ts" setup>
  ...
  defineOptions({ name: 'YouyiRelationFormAttr', inheritAttrs: false });
  ...
  const getBindValue = computed(() => ({
    ...
    placeholder: props.isStorage ? t('component.youyi.relationFormAttr.storage') : t('component.youyi.relationFormAttr.unStorage'),
  }));
