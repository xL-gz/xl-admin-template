...
<script lang="ts" setup>
  ...
  defineOptions({ name: 'YouyiCalculate', inheritAttrs: false });
  ...
  const getBindValue = computed(() => ({
    ...
    placeholder: props.isStorage ? t('component.youyi.calculate.storage') : t('component.youyi.calculate.unStorage'),
  }));
