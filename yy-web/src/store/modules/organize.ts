...
// 占位符函数 - 后端无对应接口时返回空数据
const getDepartmentSelector = () => Promise.resolve({ data: { list: [] } });
const getPositionSelector = () => Promise.resolve({ data: { list: [] } });
const getPositionListAll = () => Promise.resolve({ data: { list: [] } });
const getGroupSelector = () => Promise.resolve({ data: [] });
const getRoleSelector = () => Promise.resolve({ data: { list: [] } });
