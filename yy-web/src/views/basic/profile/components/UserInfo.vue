        ...
        <a-row>
          ...
          <a-col :span="12">
            <a-form-item label="性别">
              <youyi-select v-model:value="form2.gender" :options="genderOptions" placeholder="请选择" :fieldNames="{ value: 'enCode' }" showSearch />
            </a-form-item>
          </a-col>
          <a-col :span="12">
            <a-form-item label="民族">
              <youyi-select v-model:value="form2.nation" :options="nationOptions" placeholder="请选择" showSearch />
            </a-form-item>
          </a-col>
          <a-col :span="12">
          ...
          <a-col :span="12">
            <a-form-item label="证件类型">
              <youyi-select v-model:value="form2.certificatesType" :options="certificatesTypeOptions" placeholder="请选择" showSearch />
            </a-form-item>
          </a-col>
          <a-col :span="12">
          ...
          <a-col :span="12">
            <a-form-item label="文化程度">
              <youyi-select v-model:value="form2.education" :options="educationOptions" placeholder="请选择" showSearch />
            </a-form-item>
          </a-col>
          <a-col :span="12">
            <a-form-item label="出生年月">
              <youyi-date-picker v-model:value="form2.birthday" placeholder="请选择" format="YYYY-MM-DD" />
            </a-form-item>
          </a-col>
          <a-col :span="12">
          ...
          <a-col :span="24">
            <a-form-item label="自我介绍">
              <youyi-textarea v-model:value="form2.signature" :maxlength="300" placeholder="请输入" />
            </a-form-item>
          </a-col>
          <a-col :span="24">
            <a-form-item label=" ">
