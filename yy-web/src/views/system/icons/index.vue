<template>
  <div class="youyi-content-wrapper icons-wrapper">
    <div class="youyi-content-wrapper-center">
      <div class="youyi-content-wrapper-search-box">
        <BasicForm class="search-form" @register="registerForm" @submit="handleSubmit" @reset="handleReset"></BasicForm>
      </div>
      <div class="youyi-content-wrapper-content bg-white">
...
<script lang="ts" setup>
  ...
  import { ymIconJson } from '@/components/Youyi/IconPicker/data/ymIcon';
  import { ymCustomJson } from '@/components/Youyi/IconPicker/data/ymCustom';
