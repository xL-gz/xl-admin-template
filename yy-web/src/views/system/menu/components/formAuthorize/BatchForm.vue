...
<script lang="ts" setup>
  ...
  // import { batchCreate } from '@/api/system/formAuthorize'; // 已删除 - 后端无此接口
  // 占位符函数 - 仅用于展示
  const batchCreate = (_?: any) => Promise.resolve({ msg: '操作成功' });
  ...
  async function handleSubmit() {
    ...
    state.dataForm.formJson = JSON.parse(columnJson);
