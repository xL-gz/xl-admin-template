<template>
  <div class="common-container">
    ...
    <a-modal v-model:open="visible" title="数据选择" :width="800" class="youyi-list-modal" @ok="handleSubmit" @cancel="handleCancel">
      <template #closeIcon>
...
<script lang="ts" setup>
  // import { getDataModelList } from '@/api/systemData/dataModel'; // 已删除 - 后端无此接口
  // 占位符函数 - 仅用于展示
  const getDataModelList = (_?: any) => Promise.resolve({ data: { list: [], pagination: { total: 0 } } });
