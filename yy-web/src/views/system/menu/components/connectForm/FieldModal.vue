  ...
  <div class="common-container">
    ...
    <a-modal
      ...
      <div class="youyi-content-wrapper">
        <div class="youyi-content-wrapper-left">
...
<script lang="ts" setup>
  // import { getTableInfoByTableName } from '@/api/system/authorize'; // 已删除 - 后端无此接口
  // 占位符函数 - 仅用于展示
  const getTableInfoByTableName = (_?: any) => Promise.resolve({ data: {} });
