...
<script lang="ts" setup>
  ...
  // import { getButtonAuthorizeSelector, create, update, getInfo } from '@/api/system/buttonAuthorize'; // 已删除 - 后端无此接口
  // 占位符函数 - 仅用于展示
  const getButtonAuthorizeSelector = (_?: any) => Promise.resolve({ data: { list: [] } });
