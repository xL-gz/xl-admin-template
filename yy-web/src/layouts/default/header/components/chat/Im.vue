  ...
  <div class="im-container" v-if="visible">
    ...
    <div class="main">
      <div class="chatBox">
        ...
        <div class="writeBox">
          <youyi-textarea placeholder="点击这里，直接输入消息咨询" v-model:value.trim="messageContent" @keyup.enter.native="sendMessage()" />
          <div class="btns">
...
<style lang="less">
  .im-container {
    .chatList-item.chatList-item--mine .chatList-text {
